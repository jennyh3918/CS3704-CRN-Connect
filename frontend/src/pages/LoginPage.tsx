  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen w-full bg-slate-50 text-slate-900 px-4">
      <div className="bg-white p-10 rounded-2xl shadow-xl w-full max-w-md border border-slate-100">
        <h1 className="text-3xl font-extrabold mb-2 text-center text-slate-900 tracking-tight">Welcome back</h1>
        ...
        <form onSubmit={handleSignIn} className="flex flex-col gap-6">
          ...
          <div className="text-center mt-2">
            ...
            <Link to="/signup" className="text-blue-600 text-sm font-bold hover:underline">
              Create one
            </Link>
          </div>
        </form>
